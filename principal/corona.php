            ...
            <div class="row text-center">
                <div class="col-12 col-md-10 col-lg-8 offset-md-1 offset-lg-2 wow zoomIn heading-area"
                    ...
                    <h3 class="heading text-center"> </h3> <span class="d-block;"
                        style="color: #2f4ba5 !important; font-family: 'Sofia', serif;"> Corona de Caridad</span>
                </div>
            </div>
            <!--Heading-->
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 text-justify">
                        <h3 style="font-size: 22px;">
                            ...
                            <br>
                            <br>
                            <span style="text-decoration: underline;">Procedimientos para enviar una corona de caridad:</span>
                            <br><br>
