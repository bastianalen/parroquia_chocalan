        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-12 col-md-10 col-lg-8 offset-md-1 offset-lg-2 wow zoomIn heading-area"
                    ...
                    <br>
                    <br>
                    <span class="d-block;" style="color: #2f4ba5 !important; font-family: 'Sofia', serif;"> Cementerio
                    </span><br><br>
                    <span class="d-block;" style="color: #2f4ba5 !important; font-family: 'Sofia', serif;">
                        Parroquial de
                        Chocalán</span>
                </div>
            </div>
            ...
            <div class="row  padding-top-half"
                ...
                <div class="row ">
                    <div class="col-md-4 mb-4">
                        <img src="vista/img/cemen.jpg" class="img-fluid" alt="Imagen 2"
                    ...
                    <div class="col-md-12 text-justify">
                        <h3 style="font-size: 22px;">
                            ...
                            <br>
                            <br>
                            <span style="text-decoration: underline;">Procedimientos para
                                sepultación:</span>
                            <br><br>
