            ...
            <div class="row text-center">
                <div class="col-12 col-md-10 col-lg-8 offset-md-1 offset-lg-2 wow zoomIn heading-area"
                    ...
                    <h3 class="heading text-center"> </h3> <span class="d-block;"
                        style="color: #2f4ba5 !important; font-family: 'Sofia', serif;"> Velatorio</span>
                </div>
            </div>
            <!--Heading-->
            <div class="row  padding-top-half"
                style=" serif; font-size: 18px; border: 2px solid #2f4ba5; padding: 20px; border-radius: 15px;">
                <div class="row ">
                    <div class="col-md-4 mb-4">
                        <img src="vista/img/velatorio.png" class="img-fluid" alt="Imagen 2"
                    ...
                    <div class="col-md-12 text-justify">
                        <h3 style="font-size: 22px;">
                            ...
                            <br>
                            <br>
                            <span style="text-decoration: underline;">Procedimientos para acceder a velatorio:</span>
                            <br><br>
