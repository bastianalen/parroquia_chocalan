...
<body data-spy="scroll" data-target=".navbar" data-offset="90">
    ...
    <header id="home" class="header-style4 header-style8">
        ...
        <div class="lower-nav lower-nav-style4 div-cream-color div-cream-color">
            <div class="container">
            ...
            <div class="row padding-top-half container-info">
                <div class="row ">
                    <div class="col-md-4 mb-4">
                        <img src="../vista/img/comunion.jpg" class="img-fluid" alt="Imagen 2">
                    </div>
                    <div class="col-md-8 text-justify">
                        <h4>
                            ...
                            en
                            adelante participando con cierta regularidad del sacramento de la comunión y por
                            consiguiente de
                            la
