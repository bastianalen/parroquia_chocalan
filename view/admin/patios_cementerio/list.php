...
<form action="../../../controller/controllerpatioscementerio.php?action=delete" Method="POST">
			...
			<tbody>
				...
				foreach ($sectores as $result) {
					...
					echo '<td align="center"><a title="Edit" href="index.php?view=edit&id=' . $result['id_sector'] . '" class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa"></a>
				  		     <a title="Delete" href="../../../controller/controllerpatioscementerio.php?action=delete&id=' . $result['id_sector'] . '" class="btn btn-danger btn-xs  ">  <span class="fa  fa-trash-o fw-fa "></a></td>';
					// echo '<td></td>';
					echo '</tr>';
				}
				?>
