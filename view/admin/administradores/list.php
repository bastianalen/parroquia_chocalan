...
<div class="row">
        	...
        	<!-- /.col-lg-12 -->
	 		    ...
	 		    <form action="../../../controller/controlleradministradores.php?action=delete" Method="POST">  
				  	...
				  	<?php 
						...
						foreach ($users as $result) {
				  		...
				  		echo '<td align="center" > <a title="Editar" href="index.php?view=edit&id='.$result['user_id'].'"  class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa"></span></a>
				  					 <a title="Borrar" href="../../../controller/controlleradministradores.php?action=delete&id='.$result['user_id'].'" class="btn btn-danger btn-xs" ><span class="fa fa-trash-o fw-fa"></span> </a>
				  					 </td>';
				  		echo '</tr>';
				  	} 
				  	?>
