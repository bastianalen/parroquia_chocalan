  ...
  <fieldset>
    ...
    <div class="form-group">
      <div class="col-md-8">
        ...
        <div class="col-md-8">
          ...
          <input class="form-control input-sm" id="U_NAME" name="U_NAME" placeholder="nombre de la cuenta" type="text"
    ...
    <div class="form-group">
      <div class="col-md-8">
        ...
        <div class="col-md-8">
          <input name="deptid" type="hidden" value="">
          <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder="correo" type="text"
